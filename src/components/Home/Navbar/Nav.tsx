    ...
    <div className="bg-blue-950 transition-all duration-200 h-[12vh] z-[1000] fixed w-full">
      <div className="flex items-center h-full justify-between w-[90%] x1:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-x1 md:text 2x1 text-white uppercase font-bold">Portal PCD</h1>
        </div>
        {/* {Navlinks} */}
        ...
        <div className="lg:hidden">
          <GiHamburgerMenu onClick={openNav} className="w-6 h-6 text-white cursor-pointer" />
        </div>
      </div>
    </div>
  )
